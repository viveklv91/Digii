  ...
  ?>
    ...
    <div class="row block-9 justify-content-center mb-1">
          <div class="col-md-10 mb-md-5">
            <h2 class="text-center"> - Activate Users -</h2>
              ...
              <div class="col-lg-12">
                                <div class="table-responsive table--no-card m-b-30">
                                    <table class="table table-borderless table-striped table-earning" id="memTable" name="memTable">
                                        ...
                                        <tbody>
                                          <?php $sql = "SELECT * FROM `tbluser` WHERE `activation`=0;";
                                ...
                                ' </td><td> ' . $row["userType"] . ' </td><td> ' .
                                 ...
                                 $row["dateOfBirth"] . ' </td><td> ' .
                                  $row["contactNumber"] . ' </td><td> ' .
                                   $row["address"] .' </td><td> ' .
                                   $row["email"] .
                                    ' </td><td><input type="submit" name="activate" id="activate" value="Activate" formaction="../actions/activateUser.php?uID=' . $row["userID"] . '" class="btn btn-primary py-1 px-3"></tr></form>';
                            }
                        }?>
                                        </tbody>
                                    </table>
