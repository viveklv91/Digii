<?php 
session_start();
if(isset($_SESSION['user_id']) && isset($_SESSION['user_type']) && $_SESSION['user_type'] =='Advertiser')
{
	//continue
}else{
  			...
  			<div class="row tabulation mt-4 ftco-animate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  				<div class="col-md-3">
						<ul class="nav nav-pills nav-fill d-md-flex d-block flex-column">
						  ...
						  <li class="nav-item text-left">
						    <a class="nav-link py-4" href="logOut.php"><span class="flaticon-search-engine mr-2"></span> Sign Out</a>
						  </li>
						</ul>
					</div>
					<div class="col-md-8">
