...
$_SESSION["active"] = "confirmwebsites";
include '../db_conn.php';
  ...
  ?>
    ...
    <div class="row block-9 justify-content-center mb-1">
          <div class="col-md-10 mb-md-5">
            <h2 class="text-center"> - Confirm Websites -</h2>
                                    ...
                                    <table class="table table-borderless table-striped table-earning" id="memTable" name="memTable">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Domain URL</th>                                                
                                                <th>Company Logo</th>
                                                <th>Confirm Website</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                          <?php $sql = "SELECT * FROM `tblregisteredwebsite` WHERE `approval`=0;";
                                ...
                                ' </td><td> ' . $row["userID"] . ' </td><td> ' .
                                 ...
                                 $row["webType"] . ' </td><td> ' .
                                  $row["domain"] . ' </td><td><img src=../../digii/actions/' .
                                   ...
                                   <td><input type="submit" name="confirm" id="confirm" value="Confirm" formaction="../actions/confirmWeb.php?wID=' . $row["webID"] . '" class="btn btn-primary py-1 px-3"></tr></form>';
                            }
                        }?>
                                        </tbody>
                                    </table>
